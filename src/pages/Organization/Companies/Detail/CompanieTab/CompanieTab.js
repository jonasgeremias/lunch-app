...
import { getCompanieData, setCompanieData } from 'utils/firebase/companies';
...
const CompanieTab = ({ add }) => {
   ...
   const formik = useFormik({
      ...
      onSubmit: async (values) => {
         ...
         const { error, message, data, newDoc } = await setCompanieData(dataset, add, user, org)
         setLoading(false)
